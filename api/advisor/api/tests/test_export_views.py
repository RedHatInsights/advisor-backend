...
class ExportViewTestCase(TestCase):
    ...
    def test_systems_export(self):
        ...
        self.assertEqual(row_data[1]['rhel_version'], '7.5')
        self.assertEqual(row_data[1]['group_name'], 'Ungrouped Hosts')
        ...
        self.assertEqual(row_data[2]['last_seen'], '2018-12-04T05:10:36Z')
        ...
        self.assertEqual(row_data[3]['rhel_version'], '7.5')
        self.assertEqual(row_data[3]['group_name'], 'Ungrouped Hosts')
        ...
        self.assertEqual(row_data[4]['group_name'], 'Ungrouped Hosts')
