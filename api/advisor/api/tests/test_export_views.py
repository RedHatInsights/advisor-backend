...
class ExportViewTestCase(TestCase):
    ...
    def test_systems_export(self):
        ...
        self.assertGreater(row_data[0]['last_seen'], '2018-09-22T02:00:51Z')
        ...
        self.assertGreater(row_data[1]['last_seen'], '2018-12-10T23:32:13Z')
        ...
        self.assertGreater(row_data[2]['last_seen'], '2018-12-04T05:15:38Z')
        ...
        self.assertGreater(row_data[3]['last_seen'], '2019-04-05T14:30:00Z')
        ...
        self.assertGreater(row_data[4]['last_seen'], '2018-12-10T23:32:15Z')
...
class ExportViewHostTagsTestCase(TestCase):
    ...
    def test_host_and_rule_export(self):
        ...
        self.assertGreater(row_data[0]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[0]['title'], constants.active_title)
        ...
        self.assertGreater(row_data[1]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[1]['title'], constants.active_title)
        ...
        self.assertGreater(row_data[2]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[2]['title'], constants.second_title)
        ...
        self.assertGreater(row_data[3]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[3]['title'], constants.active_title)
        ...
        self.assertGreater(row_data[4]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[4]['title'], constants.second_title)
        ...
        self.assertGreater(row_data[5]['last_seen'], '2019-12-17T02:00:51+00:00')
        self.assertEqual(row_data[5]['title'], constants.active_title)
        ...
        self.assertGreater(row_data[6]['last_seen'], '2019-12-17T02:00:51+00:00')
    ...
    def test_systems_export(self):
        ...
        self.assertGreater(row_data[0]['last_seen'], '2019-12-17T02:00:51Z')
        ...
        self.assertGreater(row_data[1]['last_seen'], '2019-12-17T02:00:51Z')
        self.assertEqual(row_data[1]['hits'], '2')
        self.assertEqual(row_data[1]['critical_hits'], '0')
        self.assertEqual(row_data[1]['important_hits'], '0')
        self.assertEqual(row_data[1]['moderate_hits'], '0')
        ...
        self.assertGreater(row_data[2]['last_seen'], '2019-12-17T02:00:51Z')
        ...
        self.assertGreater(row_data[3]['last_seen'], '2019-12-17T02:00:51Z')
