...
class SystemViewTestCase(TestCase):
    ...
    def test_list_system(self):
        ...
        self.assertGreater(systems[0]['last_seen'], '2018-09-22T02:00:51Z')
        ...
        self.assertGreater(systems[1]['last_seen'], '2018-12-10T23:32:13Z')
        ...
        self.assertGreater(systems[2]['last_seen'], '2018-12-04T05:15:38Z')
        ...
        self.assertGreater(systems[3]['last_seen'], '2019-04-05T14:30:00Z')
        ...
        self.assertGreater(systems[4]['last_seen'], '2018-12-10T23:32:15Z')
    ...
    def test_list_system_last_seen_sort(self):
        ...
        self.assertIsInstance(systems, list)
        self.assertEqual(len(systems), 5)
        # Because the 'last seen' is now based on the per_reporter_staleness
        # last_check_in field, which is generated by the update_stale_dates
        # function to be current, the actual dates and the order of the systems
        # is now no longer dependent purely on the date in the upload.
        # So there's not a lot of point in actually checking which order the
        # systems were listed in - it's probably based on the order the systems
        # are processed by update_stale_dates.
    ...
    def test_get_system(self):
        ...
        self.assertGreater(system['last_seen'], '2018-12-04T05:15:38Z')
    ...
    def test_get_system_with_no_hits(self):
        ...
        self.assertGreater(system['last_seen'], '2018-12-10T23:32:15Z')
...
class SystemHostTagsViewTestCase(TestCase):
    ...
    def test_get_system(self):
        ...
        self.assertGreater(system['last_seen'], '2019-12-17T02:00:51Z')
